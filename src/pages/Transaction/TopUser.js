            ...
            <div className="table-responsive">
              <Table className="table-borderless table-centered table-nowrap">
                <tbody>
                  <tr>
                    <td style={{ width: "20px" }}>
                      <img src={avatar4} className="avatar-xs rounded-circle " alt="..." />
                    </td>
                    <td>
                    ...
                    <td className="text-muted fw-semibold text-end">
                      <FeatherIcon icon="trending-up" className="icon-xs icon me-2 text-success" />
                      $250.00
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <img src={avatar5} className="avatar-xs rounded-circle " alt="..." />
                    </td>
                    <td>
                    ...
                    <td className="text-muted fw-semibold text-end">
                      <FeatherIcon icon="trending-down" className="icon-xs icon me-2 text-danger" />
                      $110.00
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <img src={avatar6} className="avatar-xs rounded-circle " alt="..." />
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <img src={avatar7} className="avatar-xs rounded-circle " alt="..." />
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <img src={avatar8} className="avatar-xs rounded-circle " alt="..." />
                    </td>
                    <td>
