...
import { del, fetchRequest, get, post, put } from "./api_helper"
...
// Edit profile
const postEditProfile = data => post(url.POST_EDIT_JWT_PROFILE, data)
...
export const getShops = async () => {
  const url = `/shops/fetch/?limit=8&deleted=0&username=sopfiebabe`
  const shopsresult = await fetchRequest(url, "GET", false)

  return shopsresult.result
}
...
//delete invoice
export const deleteInvoice = invoice => del(url.DELETE_INVOICE, { headers: { invoice } })
